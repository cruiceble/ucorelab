...
print_stat(const char *name, int fd, struct stat *stat) {
  ...
  800266:	c7 04 24 e0 1a 80 00 	movl   $0x801ae0,(%esp)
  ...
  800284:	c7 04 24 eb 1a 80 00 	movl   $0x801aeb,(%esp)
  ...
  80029a:	c7 04 24 fd 1a 80 00 	movl   $0x801afd,(%esp)
  ...
  8002b0:	c7 04 24 10 1b 80 00 	movl   $0x801b10,(%esp)
  ...
  8002c6:	c7 04 24 23 1b 80 00 	movl   $0x801b23,(%esp)
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800306:	c7 04 24 36 1b 80 00 	movl   $0x801b36,(%esp)
  ...
  80031f:	e8 7e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800324:	c7 04 24 50 1b 80 00 	movl   $0x801b50,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800356:	c7 04 24 52 1b 80 00 	movl   $0x801b52,(%esp)
  ...
  80036f:	e8 2e 00 00 00       	call   8003a2 <vcprintf>
    cprintf("\n");
  800374:	c7 04 24 50 1b 80 00 	movl   $0x801b50,(%esp)
...
exit(int error_code) {
  ...
  8008d3:	c7 04 24 6e 1b 80 00 	movl   $0x801b6e,(%esp)
...
umain(int argc, char *argv[]) {
  ...
  800a3f:	00 
  800a40:	c7 44 24 04 81 1b 80 	movl   $0x801b81,0x4(%esp)
  800a47:	00 
  ...
  800a64:	c7 44 24 08 88 1b 80 	movl   $0x801b88,0x8(%esp)
  800a6b:	00 
  800a6c:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  800a73:	00 
  800a74:	c7 04 24 a2 1b 80 00 	movl   $0x801ba2,(%esp)
  800a7b:	e8 bc f8 ff ff       	call   80033c <__warn>
    }
    if ((fd = initfd(1, "stdout:", O_WRONLY)) < 0) {
  800a80:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  800a87:	00 
  800a88:	c7 44 24 04 b4 1b 80 	movl   $0x801bb4,0x4(%esp)
  800a8f:	00 
  ...
  800aac:	c7 44 24 08 bc 1b 80 	movl   $0x801bbc,0x8(%esp)
  800ab3:	00 
  800ab4:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%esp)
  800abb:	00 
  800abc:	c7 04 24 a2 1b 80 00 	movl   $0x801ba2,(%esp)
...
printnum(void (*putch)(int, void*, int), int fd, void *putdat,
  ...
  800c04:	05 e4 1d 80 00       	add    $0x801de4,%eax
...
vprintfmt(void (*putch)(int, void*, int), int fd, void *putdat, const char *fmt, va_list ap) {
  ...
  800d68:	8b 04 85 08 1e 80 00 	mov    0x801e08(,%eax,4),%eax
  ...
  800e81:	c7 44 24 0c fe 1d 80 	movl   $0x801dfe,0xc(%esp)
  800e88:	00 
  ...
  800eb4:	75 05                	jne    800ebb <vprintfmt+0x1c9>
                p = "(null)";
  800eb6:	be 01 1e 80 00       	mov    $0x801e01,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801802:	e8 7d f1 ff ff       	call   800984 <gettime_msec>
  801807:	89 44 24 18          	mov    %eax,0x18(%esp)
     cprintf("priority process will sleep %d ticks\n",SLEEP_TIME);
  80180b:	c7 44 24 04 90 01 00 	movl   $0x190,0x4(%esp)
  801812:	00 
  801813:	c7 04 24 60 1f 80 00 	movl   $0x801f60,(%esp)
  80181a:	e8 be eb ff ff       	call   8003dd <cprintf>
     sleep(SLEEP_TIME);
  80181f:	c7 04 24 90 01 00 00 	movl   $0x190,(%esp)
  801826:	e8 46 f1 ff ff       	call   800971 <sleep>
     memset(pids, 0, sizeof(pids));
  80182b:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
  801832:	00 
  801833:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80183a:	00 
  80183b:	c7 04 24 70 31 80 00 	movl   $0x803170,(%esp)
  801842:	e8 fb fd ff ff       	call   801642 <memset>
     lab6_set_priority(TOTAL + 1);
  801847:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
  80184e:	e8 0b f1 ff ff       	call   80095e <lab6_set_priority>

     for (i = 0; i < TOTAL; i ++) {
  801853:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  80185a:	00 
  80185b:	e9 13 01 00 00       	jmp    801973 <main+0x17c>
          acc[i]=0;
  801860:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801864:	c7 04 85 48 31 80 00 	movl   $0x0,0x803148(,%eax,4)
  80186b:	00 00 00 00 
          if ((pids[i] = fork()) == 0) {
  80186f:	e8 6d f0 ff ff       	call   8008e1 <fork>
  801874:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  801878:	89 04 95 70 31 80 00 	mov    %eax,0x803170(,%edx,4)
  80187f:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801883:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  80188a:	85 c0                	test   %eax,%eax
  80188c:	0f 85 bf 00 00 00    	jne    801951 <main+0x15a>
               lab6_set_priority(i + 1);
  801892:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801896:	83 c0 01             	add    $0x1,%eax
  801899:	89 04 24             	mov    %eax,(%esp)
  80189c:	e8 bd f0 ff ff       	call   80095e <lab6_set_priority>
               acc[i] = 0;
  8018a1:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8018a5:	c7 04 85 48 31 80 00 	movl   $0x0,0x803148(,%eax,4)
  8018ac:	00 00 00 00 
               while (1) {
                    spin_delay();
  8018b0:	e8 16 ff ff ff       	call   8017cb <spin_delay>
                    ++ acc[i];
  8018b5:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8018b9:	8b 04 85 48 31 80 00 	mov    0x803148(,%eax,4),%eax
  8018c0:	8d 50 01             	lea    0x1(%eax),%edx
  8018c3:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8018c7:	89 14 85 48 31 80 00 	mov    %edx,0x803148(,%eax,4)
                    if(acc[i]%4000==0) {
  8018ce:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8018d2:	8b 0c 85 48 31 80 00 	mov    0x803148(,%eax,4),%ecx
  8018d9:	ba d3 4d 62 10       	mov    $0x10624dd3,%edx
  8018de:	89 c8                	mov    %ecx,%eax
  8018e0:	f7 e2                	mul    %edx
  8018e2:	89 d0                	mov    %edx,%eax
  8018e4:	c1 e8 08             	shr    $0x8,%eax
  8018e7:	69 c0 a0 0f 00 00    	imul   $0xfa0,%eax,%eax
  8018ed:	29 c1                	sub    %eax,%ecx
  8018ef:	89 c8                	mov    %ecx,%eax
  8018f1:	85 c0                	test   %eax,%eax
  8018f3:	75 57                	jne    80194c <main+0x155>
                        if((time=gettime_msec())>start_time+SLEEP_TIME+MAX_TIME) {
  8018f5:	e8 8a f0 ff ff       	call   800984 <gettime_msec>
  8018fa:	89 44 24 14          	mov    %eax,0x14(%esp)
  8018fe:	8b 44 24 18          	mov    0x18(%esp),%eax
  801902:	05 78 05 00 00       	add    $0x578,%eax
  801907:	39 44 24 14          	cmp    %eax,0x14(%esp)
  80190b:	7e 3f                	jle    80194c <main+0x155>
                            cprintf("child pid %d, acc %d, time %d\n",getpid(),acc[i],time);
  80190d:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801911:	8b 1c 85 48 31 80 00 	mov    0x803148(,%eax,4),%ebx
  801918:	e8 27 f0 ff ff       	call   800944 <getpid>
  80191d:	8b 54 24 14          	mov    0x14(%esp),%edx
  801921:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801925:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  801929:	89 44 24 04          	mov    %eax,0x4(%esp)
  80192d:	c7 04 24 88 1f 80 00 	movl   $0x801f88,(%esp)
  801934:	e8 a4 ea ff ff       	call   8003dd <cprintf>
                            exit(acc[i]);
  801939:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80193d:	8b 04 85 48 31 80 00 	mov    0x803148(,%eax,4),%eax
  801944:	89 04 24             	mov    %eax,(%esp)
  801947:	e8 76 ef ff ff       	call   8008c2 <exit>
                        }
                    }
               }
  80194c:	e9 5f ff ff ff       	jmp    8018b0 <main+0xb9>
               
          }
          if (pids[i] < 0) {
  801951:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801955:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  80195c:	85 c0                	test   %eax,%eax
  80195e:	79 0e                	jns    80196e <main+0x177>
               goto failed;
  801960:	90                   	nop
     cprintf("\n");
...
failed:
     for (i = 0; i < TOTAL; i ++) {
  801961:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801968:	00 
  801969:	e9 32 01 00 00       	jmp    801aa0 <main+0x2a9>
     cprintf("priority process will sleep %d ticks\n",SLEEP_TIME);
     sleep(SLEEP_TIME);
     memset(pids, 0, sizeof(pids));
     lab6_set_priority(TOTAL + 1);
     ...
     for (i = 0; i < TOTAL; i ++) {
  80196e:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801973:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801978:	0f 8e e2 fe ff ff    	jle    801860 <main+0x69>
          if (pids[i] < 0) {
               goto failed;
          }
     }
  ...
  80197e:	c7 04 24 a8 1f 80 00 	movl   $0x801fa8,(%esp)
  801985:	e8 53 ea ff ff       	call   8003dd <cprintf>

     for (i = 0; i < TOTAL; i ++) {
  80198a:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801991:	00 
  801992:	eb 6b                	jmp    8019ff <main+0x208>
         status[i]=0;
  801994:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801998:	c7 04 85 5c 31 80 00 	movl   $0x0,0x80315c(,%eax,4)
  80199f:	00 00 00 00 
         waitpid(pids[i],&status[i]);
  8019a3:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8019a7:	c1 e0 02             	shl    $0x2,%eax
  8019aa:	8d 90 5c 31 80 00    	lea    0x80315c(%eax),%edx
  8019b0:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8019b4:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  8019bb:	89 54 24 04          	mov    %edx,0x4(%esp)
  8019bf:	89 04 24             	mov    %eax,(%esp)
  8019c2:	e8 43 ef ff ff       	call   80090a <waitpid>
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
  8019c7:	e8 b8 ef ff ff       	call   800984 <gettime_msec>
  8019cc:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  8019d0:	8b 0c 95 5c 31 80 00 	mov    0x80315c(,%edx,4),%ecx
  8019d7:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  8019db:	8b 14 95 70 31 80 00 	mov    0x803170(,%edx,4),%edx
  8019e2:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8019e6:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  8019ea:	89 54 24 04          	mov    %edx,0x4(%esp)
  8019ee:	c7 04 24 d0 1f 80 00 	movl   $0x801fd0,(%esp)
  8019f5:	e8 e3 e9 ff ff       	call   8003dd <cprintf>
          }
     }
     ...
     for (i = 0; i < TOTAL; i ++) {
  8019fa:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  8019ff:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801a04:	7e 8e                	jle    801994 <main+0x19d>
         status[i]=0;
         waitpid(pids[i],&status[i]);
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
     }
     cprintf("main: wait pids over\n");
  801a06:	c7 04 24 ef 1f 80 00 	movl   $0x801fef,(%esp)
  801a0d:	e8 cb e9 ff ff       	call   8003dd <cprintf>
     cprintf("stride sched correct result:");
  801a12:	c7 04 24 05 20 80 00 	movl   $0x802005,(%esp)
  801a19:	e8 bf e9 ff ff       	call   8003dd <cprintf>
     for (i = 0; i < TOTAL; i ++)
  801a1e:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801a25:	00 
  801a26:	eb 37                	jmp    801a5f <main+0x268>
     {
         cprintf(" %d", (status[i] * 2 / status[0] + 1) / 2);
  801a28:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801a2c:	8b 04 85 5c 31 80 00 	mov    0x80315c(,%eax,4),%eax
  801a33:	01 c0                	add    %eax,%eax
  801a35:	8b 35 5c 31 80 00    	mov    0x80315c,%esi
  801a3b:	99                   	cltd   
  801a3c:	f7 fe                	idiv   %esi
  801a3e:	83 c0 01             	add    $0x1,%eax
  801a41:	89 c2                	mov    %eax,%edx
  801a43:	c1 ea 1f             	shr    $0x1f,%edx
  801a46:	01 d0                	add    %edx,%eax
  801a48:	d1 f8                	sar    %eax
  801a4a:	89 44 24 04          	mov    %eax,0x4(%esp)
  801a4e:	c7 04 24 22 20 80 00 	movl   $0x802022,(%esp)
  801a55:	e8 83 e9 ff ff       	call   8003dd <cprintf>
         waitpid(pids[i],&status[i]);
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
     }
     cprintf("main: wait pids over\n");
     cprintf("stride sched correct result:");
     for (i = 0; i < TOTAL; i ++)
  801a5a:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801a5f:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801a64:	7e c2                	jle    801a28 <main+0x231>
     {
         cprintf(" %d", (status[i] * 2 / status[0] + 1) / 2);
     }
     cprintf("\n");
  801a66:	c7 04 24 26 20 80 00 	movl   $0x802026,(%esp)
  801a6d:	e8 6b e9 ff ff       	call   8003dd <cprintf>

     return 0;
  801a72:	b8 00 00 00 00       	mov    $0x0,%eax
  801a77:	eb 4a                	jmp    801ac3 <main+0x2cc>

failed:
     for (i = 0; i < TOTAL; i ++) {
          if (pids[i] > 0) {
  801a79:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801a7d:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  801a84:	85 c0                	test   %eax,%eax
  801a86:	7e 13                	jle    801a9b <main+0x2a4>
               kill(pids[i]);
  801a88:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801a8c:	8b 04 85 70 31 80 00 	mov    0x803170(,%eax,4),%eax
  801a93:	89 04 24             	mov    %eax,(%esp)
  801a96:	e8 96 ee ff ff       	call   800931 <kill>
     cprintf("\n");
...
failed:
     for (i = 0; i < TOTAL; i ++) {
  801a9b:	83 44 24 1c 01       	addl   $0x1,0x1c(%esp)
  801aa0:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801aa5:	7e d2                	jle    801a79 <main+0x282>
          if (pids[i] > 0) {
               kill(pids[i]);
          }
     }
     panic("FAIL: T.T\n");
  801aa7:	c7 44 24 08 28 20 80 	movl   $0x802028,0x8(%esp)
  801aae:	00 
  801aaf:	c7 44 24 04 4f 00 00 	movl   $0x4f,0x4(%esp)
  801ab6:	00 
  801ab7:	c7 04 24 33 20 80 00 	movl   $0x802033,(%esp)
  801abe:	e8 29 e8 ff ff       	call   8002ec <__panic>
}
